...
const Hero = ({ id }) => {
  ...
  return (
    ...
    >
      ...
      {/* Nebulosas Estelares (Nubes cósmicas de fondo - Optimizadas para móvil GPU) */}
      <div className="absolute top-[-10%] left-[-10%] w-[400px] md:w-[700px] h-[400px] md:h-[700px] bg-[#5E1F94] opacity-30 md:opacity-40 rounded-full blur-3xl md:blur-[100px] pointer-events-none animate-[float_12s_ease-in-out_infinite] md:mix-blend-screen overflow-hidden" style={{ willChange: 'transform, opacity' }}></div>
      <div className="absolute top-[30%] right-[-10%] w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-[#00f2fe] opacity-15 md:opacity-20 rounded-full blur-3xl md:blur-[90px] pointer-events-none animate-[float_18s_ease-in-out_infinite_reverse] md:mix-blend-screen overflow-hidden" style={{ willChange: 'transform, opacity' }}></div>
      <div className="absolute bottom-[-10%] left-[20%] w-[500px] md:w-[800px] h-[500px] md:h-[800px] bg-[#FF416C] opacity-10 md:opacity-15 rounded-full blur-3xl md:blur-[120px] pointer-events-none animate-[float_25s_ease-in-out_infinite] md:mix-blend-screen overflow-hidden" style={{ willChange: 'transform, opacity' }}></div>
      ...
      <div className="osn-hero__content relative z-10 text-center px-6 max-w-4xl mx-auto flex flex-col items-center mt-8">
        ...
        <div className={`osn-hero__logo-wrapper flex items-center justify-center mb-8 rounded-full transition-opacity duration-1000 relative ${mounted ? 'opacity-100' : 'opacity-0'}`}>
          ...
          >
             ...
             {/* Órbita 1 */}
             <div className="absolute top-1/2 left-1/2 w-[85vw] h-[85vw] max-w-[350px] max-h-[350px] md:max-w-[450px] md:max-h-[450px] md:w-[450px] md:h-[450px]" style={{ transform: 'translate(-50%, -50%) rotateX(65deg) rotateY(-15deg)', transformStyle: 'preserve-3d', willChange: 'transform' }}>
               <div className="w-full h-full rounded-full border-[2px] border-[rgba(255,255,255,0.15)] animate-[spin_15s_linear_infinite] relative" style={{ transformStyle: 'preserve-3d', willChange: 'transform' }}>
             ...
             {/* Órbita 2 */}
             <div className="absolute top-1/2 left-1/2 w-[100vw] h-[100vw] max-w-[450px] max-h-[450px] md:max-w-[580px] md:max-h-[580px] md:w-[580px] md:h-[580px]" style={{ transform: 'translate(-50%, -50%) rotateX(75deg) rotateY(25deg)', transformStyle: 'preserve-3d', willChange: 'transform' }}>
               <div className="w-full h-full rounded-full border-[1.5px] border-[rgba(255,255,255,0.1)] animate-[spin_25s_linear_reverse_infinite] relative" style={{ transformStyle: 'preserve-3d', willChange: 'transform' }}>
             ...
             <img 
               src={logoOsonauta} 
               alt="Logo de Osonauta para agencia de marketing en Durango" 
               fetchPriority="high"
        ...
        <div 
          className="osn-hero__actions flex flex-col sm:flex-row gap-6 items-center justify-center w-full relative z-20"
          style={{ 
             opacity: 0, 
             animation: mounted ? 'fadeSlideUp 0.8s ease-out 0.3s forwards' : 'none' 
          }}
